...
export default function PlanosPlanejamento() {
  ...
  const handleSave = () => {
    console.log('Salvando planejamento:', content);
  ...
  return (
    <div className="w-full h-full flex gap-4">
      <Container
        icon={BarChart3}
        title="Planejamento"
        description="Defina e documente o planejamento estratégico da sua empresa."
      >
          ...
          <div className="bg-white rounded-3xl p-6 border border-gray-200 shadow-sm">
            <div className="flex flex-col gap-4">
              <textarea
                ...
                placeholder="Digite aqui o conteúdo sobre o planejamento estratégico..."
