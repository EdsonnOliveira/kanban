...
export default function PlanosIdentidade() {
  ...
  const handleSave = () => {
    console.log('Salvando identidade:', content);
  ...
  return (
    <div className="w-full h-full flex gap-4">
      <Container
        icon={Target}
        title="Identidade"
        description="Defina e documente a identidade da sua empresa."
      >
          ...
          <div className="bg-white rounded-3xl p-6 border border-gray-200 shadow-sm">
            <div className="flex flex-col gap-4">
              <textarea
                ...
                placeholder="Digite aqui o conteúdo sobre a identidade da empresa..."
