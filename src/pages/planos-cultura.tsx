...
export default function PlanosCultura() {
  ...
  const handleSave = () => {
    console.log('Salvando cultura:', content);
  ...
  return (
    <div className="w-full h-full flex gap-4">
      <Container
        icon={Brain}
        title="Cultura"
        description="Defina e documente a cultura organizacional da sua empresa."
      >
          ...
          <div className="bg-white rounded-3xl p-6 border border-gray-200 shadow-sm">
            <div className="flex flex-col gap-4">
              <textarea
                ...
                placeholder="Digite aqui o conteúdo sobre a cultura organizacional..."
