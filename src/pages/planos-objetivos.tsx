...
export default function PlanosObjetivos() {
  ...
  const handleSave = () => {
    console.log('Salvando objetivos:', content);
  ...
  return (
    <div className="w-full h-full flex gap-4">
      <Container
        icon={Target}
        title="Objetivos"
        description="Defina e documente os objetivos da sua empresa."
      >
          ...
          <div className="bg-white rounded-3xl p-6 border border-gray-200 shadow-sm">
            <div className="flex flex-col gap-4">
              <textarea
                ...
                placeholder="Digite aqui o conteúdo sobre os objetivos da empresa..."
