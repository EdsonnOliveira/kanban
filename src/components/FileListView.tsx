import { FileText, Image, File, MoreHorizontal, Download, Share, Trash2, Eye } from 'lucide-react';
  ...
  const getFileIcon = (type: string, extension?: string) => {
    ...
    if (extension) {
      switch (extension.toLowerCase()) {
        case 'pptx':
          return <NextImage src="/icons/pptx.png" alt="PowerPoint" width={20} height={20} />;
        case 'pdf':
          return <NextImage src="/icons/pdf.png" alt="PDF" width={20} height={20} />;
        case 'docx':
        case 'doc':
          return <NextImage src="/icons/word.png" alt="Word" width={20} height={20} />;
        case 'xlsx':
        case 'xls':
          return <NextImage src="/icons/excel.webp" alt="Excel" width={20} height={20} />;
      }
    }
